...
# parser.add_argument('--attention', '-at', type=bool, default=False)
...
#############################################################################################
parser.add_argument('--weight_name', '-w', type=str, default='C2T_Conv0_Trans0_Pothle') # DRCNet_RDe_b3V3, DRCNet_RDe_b4V3, DRCNet_RDe_b5V3 
...
if __name__ == '__main__':
    ...
    if os.path.exists("./C2T_Conv0_Trans0_Pothle"):
        print("previous \"./C2T_Conv0_Trans0_Pothle\" folder exist, will delete this folder")
        shutil.rmtree("./C2T_Conv0_Trans0_Pothle")
    os.makedirs("./C2T_Conv0_Trans0_Pothle")
    os.chmod("./C2T_Conv0_Trans0_Pothle", stat.S_IRWXO)  # allow the folder created by docker read, written, and execuated by local machine
    ...
    batch_size = 1
    test_dataset  = NO4K_dataset(data_dir=args.data_dir, split=args.dataset_split, input_h=args.img_height, input_w=args.img_width)
    ...
    conf_total_matfile = os.path.join("./C2T_Conv0_Trans0_Pothle", 'conf_'+args.weight_name+'.mat')

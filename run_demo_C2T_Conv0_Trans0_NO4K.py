...
#############################################################################################
parser.add_argument('--weight_name', '-w', type=str, default='C2T_Conv0_Trans0_NO4K') # DRCNet_RDe_b3V3, DRCNet_RDe_b4V3, DRCNet_RDe_b5V3 
...
parser.add_argument('--data_dir', '-dr', type=str, default='./NO4K/')
...
if __name__ == '__main__':
    ...
    if os.path.exists("./C2T_Conv0_Trans0_NO4K"):
        print("previous \"./C2T_Conv0_Trans0_NO4K\" folder exist, will delete this folder")
        shutil.rmtree("./C2T_Conv0_Trans0_NO4K")
    os.makedirs("./C2T_Conv0_Trans0_NO4K")
    os.chmod("./C2T_Conv0_Trans0_NO4K", stat.S_IRWXO)  # allow the folder created by docker read, written, and execuated by local machine
    ...
    conf_total_matfile = os.path.join("./C2T_Conv0_Trans0_NO4K", 'conf_'+args.weight_name+'.mat')
